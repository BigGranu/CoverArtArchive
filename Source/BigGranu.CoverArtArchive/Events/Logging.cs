...
namespace BigGranu.CoverArtArchive.Events
{
    /// <summary>
    ///     Handler for Logging
    /// </summary>
    ...
    {
        /// <summary>
        ///     Eventhandler for new LoggingArgs
        /// </summary>
        ...
        /// <summary>
        ///     Eventhandler for new Status
        /// </summary>
        /// <param name="sender">Sender</param>
        /// <param name="e">ApiStatus</param>
